...
│   └── 12-slingshot-qe-agent/              # Track 12: SlingShot Autonomous API & UI QE Multi-Agent Framework
...
|---|---|---|---|---|
| **01** | [01-fastapi-test-management](projects/01-fastapi-test-management) | Python for AI | Beginner | High-performance async REST API with Pydantic V2 & SQLite |
| **02** | [02-llm-testcase-generator](projects/02-llm-testcase-generator) | AI Fundamentals | Beginner | CLI tool converting PRDs into positive, negative, and edge test cases |
| **03** | [03-llm-qe-assistant](projects/03-llm-qe-assistant) | LLM Engineering | Intermediate | Stack trace analyzer with Instructor structured JSON outputs |
| **04** | [04-pdf-rag-knowledge-assistant](projects/04-pdf-rag-knowledge-assistant) | RAG | Intermediate | Local ChromaDB vector assistant querying complex software PDFs |
| **05** | [05-ai-test-case-agent](projects/05-ai-test-case-agent) | AI Agents | Advanced | LangGraph cyclic reflection agent testing API specs |
| **06** | [06-qe-mcp-server](projects/06-qe-mcp-server) | MCP | Intermediate | Anthropic MCP server exposing test runners and database queries |
| **07** | [07-ai-powered-qe-eval-agent](projects/07-ai-powered-qe-eval-agent) | AI Quality Engineering | Advanced | Automated CI/CD evaluation gate using Ragas & Faithfulness benchmarks |
| **08** | [08-playwright-ai-workflow](projects/08-playwright-ai-workflow) | Automation | Intermediate | Playwright test suite with dynamic AI self-healing locators |
| **09** | [09-deploy-ai-qe-app](projects/09-deploy-ai-qe-app) | Deployment | Intermediate | Multi-stage Docker container deployed to Google Cloud Run via GitHub Actions |
